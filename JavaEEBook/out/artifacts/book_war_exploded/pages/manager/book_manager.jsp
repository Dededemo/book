    ...
    <table style="margin-top: 8px">
        ...
        <c:forEach items="${page.items}" var="book">
            <tr>
                ...
                <td><a href="javascript:void(0)" onclick="mydelete('${book.id}','${book.name}','${page.pageNo}')">删除</a>
                </td>
...
<script>
    ...
    function mydelete(id, name, pageNo) {
        ...
        //var name = aobj.parentElement.parentElement.parentElement.cells[0].innerHTML;
