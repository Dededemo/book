...
<div id="main">
<%--    id=${book.id}&imgpath=${book.imgpath}--%>
    <form action="BookServlet?action=update&pageNo=${pageNo}" enctype="multipart/form-data"
        ...
        <table>
            ...
            <tr>
                <td>价格</td>
                <td>
                    <input id="price" name="price" type="text" value="${book.price}" onblur="checkprice()"/><br/>
            ...
            <tr>
                <td>销量</td>
                <td>
                    <input id="sales" name="sales" type="text" value="${book.sales}" onblur="checksales()"/><br/>
            ...
            <tr>
                <td>库存</td>
                <td>
                    <input id="stock" name="stock" type="text" value="${book.stock}" onblur="checkstock()"/><br/>
